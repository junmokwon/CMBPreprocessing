...
from nnunetv2.experiment_planning.experiment_planners.residual_unets.residual_encoder_unet_planners import nnUNetPlannerResEncL

from nnunetv2.experiment_planning.experiment_planners.network_topology import get_pool_and_conv_props


class LocalMinimaResEncL(nnUNetPlannerResEncL):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 24,
                 preprocessor_name: str = 'LocalMinimaPreprocessor', plans_name: str = 'LocalMinimaResEncL',
    ...
    def get_plans_for_configuration(self,
        ...
        if len(spacing) == 3:
            initial_patch_size = self.desired_patch_size
        elif len(spacing) == 2:
            initial_patch_size = self.desired_patch_size[-2:]
        else:
            raise RuntimeError()
        ...
        initial_patch_size = np.array(initial_patch_size)
...
class LocalMinimaResEncL24(LocalMinimaResEncL):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 24,
                 preprocessor_name: str = 'LocalMinimaPreprocessor', plans_name: str = 'LocalMinimaResEncL24',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, overwrite_target_spacing, suppress_transpose)
        self.desired_patch_size = [24, 448, 384]


class LocalMinimaResEncL16(LocalMinimaResEncL):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 24,
                 preprocessor_name: str = 'LocalMinimaPreprocessor', plans_name: str = 'LocalMinimaResEncL16',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, overwrite_target_spacing, suppress_transpose)
        self.desired_patch_size = [16, 224, 192]


class LocalMinimaResEncL12(LocalMinimaResEncL):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 24,
                 preprocessor_name: str = 'LocalMinimaPreprocessor', plans_name: str = 'LocalMinimaResEncL12',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, overwrite_target_spacing, suppress_transpose)
        self.desired_patch_size = [12, 112, 96]
